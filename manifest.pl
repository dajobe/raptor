...
my $system_url="http://librdf.org/raptor/";
# Results URL for r:output
my $results_url="http://librdf.org/raptor/testcases/results.rdf";
# Test run output URL for r:output
my $output_url="http://librdf.org/raptor/testcases/output.txt";
