...
raptor_statement* mkr_ho(raptor_parser* rdf_parser, raptor_term* hoterm, raptor_sequence* objectList);
raptor_statement* mkr_rel(raptor_parser* rdf_parser, raptor_term* relterm, raptor_sequence* objectList);
