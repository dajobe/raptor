...
/**
 * raptor_sparql_name_check_type:
 * @RAPTOR_SPARQL_NAME_CHECK_VARNAME: SPARQL Variable name.
 * @RAPTOR_SPARQL_NAME_CHECK_PREFIXED_NAME: SPARQL / Turtle prefix name.
 * @RAPTOR_SPARQL_NAME_CHECK_LOCAL_NAME: SPARQL / Turtle local name.
 * @RAPTOR_SPARQL_NAME_CHECK_BLANK: SPARQL / Turtle blank node name.
 *
 * Check prefixed names for SPARQL and Turtle
 *
*/
typedef enum {
  RAPTOR_SPARQL_NAME_CHECK_VARNAME       = 0,
  RAPTOR_SPARQL_NAME_CHECK_PREFIXED_NAME = 1,
  RAPTOR_SPARQL_NAME_CHECK_LOCAL_NAME    = 2,
  RAPTOR_SPARQL_NAME_CHECK_BLANK         = 3
} raptor_sparql_name_check_type;


RAPTOR_API int raptor_sparql_name_check(unsigned char *string, size_t length, raptor_sparql_name_check_type check_type);
